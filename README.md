...
3. [Review the infrastructure](https://github.com/Pamir/oracle-deployment-automation/blob/feature/create-single-vm/terraform/bootstrap/single_instance/REVIEW_INFRA.md) provisioned on Azure.
4. [Install and configure Oracle DB](https://github.com/Pamir/oracle-deployment-automation/blob/feature/create-single-vm/terraform/bootstrap/single_instance/ANSIBLE.md) via ansible.
